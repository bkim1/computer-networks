...
public class PeerToBrokerUtils {
    private static final int PACKET_MAX = 512; // Maximum size of echo datagram packet payload
    ...
    public PeerInfo getSerializedPacket() throws IOException, ClassNotFoundException {
        setReceivePacket();
        int countTimeouts = 1;
    ...
    public void sendSerializedPacket(PeerInfo data) throws IOException, ClassNotFoundException {	
